...
from nnunet.training.network_training.nnUNetTrainerNoDAV2 import nnUNetTrainerNoDAV2
...
class nnUNetTrainerNoDAV2_CutMix(nnUNetTrainerNoDAV2):
    """
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if self.threeD:
            self.mixer = RandomCutMix3D(self.num_classes, p=1., alpha=1.0, inplace=True)
        else:
            self.mixer = RandomCutMix2D(self.num_classes, p=1., alpha=1.0, inplace=True)
